  ...
  <div class="home">
    <header>
      <div class="header-hd">
        ...
        <div class="header-search"><i class="search-icon"></i><span>请输入商品名称</span></div>
        <div class="header-mine"> <router-link to="/mine"><i class="mine-icon"></i></router-link></div>
      </div>
      <ul class="header-nav" >
        <router-link v-for="(item , index) in listData" :key="index" :tag="tag" :class="{ active : isActive(item.url) }" :to="item.url" class="nav-item">
           {{ item.name }}
        </router-link>
        <!-- <li class="nav-item active">商城</li>
        <li class="nav-item">衣服</li>
        <li class="nav-item">生活</li>
        <li class="nav-item">刷卡</li>
        <li class="nav-item">交通</li>
        <li class="nav-item">家庭</li>
        <li class="nav-item">家庭</li>
        <li class="nav-item">家庭</li>
        <li class="nav-item">家庭</li> -->
      </ul>   
...
.header-nav {
  ...
  .nav-item {
    ...
    font-size: 0.26rem;
    line-height: 0.64rem;
    border-bottom: 2px solid #ce560c00;
  }
  .nav-item.active {
    color: #ed5b00;
    border-color: #ed5b00;
